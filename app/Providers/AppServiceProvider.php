...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        view()->composer(['guest.gop-y-van-ban','guest.phan-anh-kien-nghi','guest.trao-doi-hoi-dap','guest.thu-vien','guest.thong-tin-doanh-nghiep','guest.nguoi-phat-ngon','guest.phong-vien-thuong-tru','guest.lien-he-cong-tac','guest.duong-day-nong', 'guest.dvc-m3','guest.ban-bien-tap','guest.gop-y-cong','guest.doanh-nghiep-hoi'],function($view){
