            ...
            <div class="modal-body">
                {!! Form::open(['method'=>'GET','url'=>'vi/tim-kiem','role'=>'search'])  !!}
                    ...
                    <div class="input-group">
                        ...
                        {{--<input type="checkbox" name="tinanh" id="tin-anh" data-toggle="toggle" data-on="Tin tức " checked >--}}

                        {{--<input type="checkbox" name="tinvideo" id="tin-video" data-toggle="toggle" data-on="Văn bản ">--}}
